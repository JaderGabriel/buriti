...
class StoreContactRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'preferred_channel' => ['required', Rule::in(['email', 'whatsapp'])],
    ...
    public function messages(): array
    {
        return [
            ...
            'phone_number.required' => 'Informe o WhatsApp para contato.',
            'phone_number.min' => 'Informe um WhatsApp válido.',
            'phone_number.regex' => 'Use apenas números no WhatsApp (sem DDI).',
            'phone.required' => 'Informe o WhatsApp para contato.',
